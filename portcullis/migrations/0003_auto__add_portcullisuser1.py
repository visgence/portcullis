...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PortcullisUser1'
        db.create_table(u'portcullis_portcullisuser1', (
            ...
            ('date_joined', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 28, 0, 0))),
        ))
        db.send_create_signal(u'portcullis', ['PortcullisUser1'])


    def backwards(self, orm):
        # Deleting model 'PortcullisUser1'
        db.delete_table(u'portcullis_portcullisuser1')
