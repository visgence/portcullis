...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DataStream', fields ['name']
        db.create_index(u'portcullis_datastream', ['name'])


    def backwards(self, orm):
        # Removing index on 'DataStream', fields ['name']
        db.delete_index(u'portcullis_datastream', ['name'])
    ...
    models = {
        ...
        u'portcullis.portcullisuser': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 17, 0, 0)'}),
