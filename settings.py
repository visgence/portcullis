...
SECRET_KEY = '+tqfll@36v!w$b@%w-jy80@)z&amp;!kqcqom2*n(-98oo^bi9k&amp;*+'
...
MIDDLEWARE_CLASSES = (
    'api.errorMiddleware.ErrorLoggingMiddleware',
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format' : '%(levelname)5s %(asctime)s %(module)s %(process)d %(thread)d %(message)s'
            }
        },
    'filters': {
        'require_debug_false': {
    ...
    'handlers': {
        ...
        'debug': {
            ...
            'filename': '/tmp/portcullis_debug.log',
            'formatter': 'verbose'
            }
        },
    'loggers': {
