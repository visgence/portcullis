...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SavedDSGraph.zoom_start'
        db.alter_column('graphs_saveddsgraph', 'zoom_start', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SavedDSGraph.zoom_end'
        db.alter_column('graphs_saveddsgraph', 'zoom_end', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'SavedDSGraph.zoom_start'
        db.alter_column('graphs_saveddsgraph', 'zoom_start', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'SavedDSGraph.zoom_end'
        db.alter_column('graphs_saveddsgraph', 'zoom_end', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        ...
        'graphs.saveddsgraph': {
            ...
            'zoom_end': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'zoom_start': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
