...
class addReadingTest(TestCase):
    ...
    def test_sensor_identifier(self):
        ...
        response = self.client.get('/api/add_reading/', {'auth_token':"apple", 'value':200})
        ...
        response = self.client.get('/api/add_reading/', {'auth_token':"apple", 'value':200, 'datastream_id':""})
        self.assertEqual(response.content, "Not enough info to uniquely identify a data stream. You must give either a datastream_id or both a node_id and a port_id. Example: \"datastream_id=1\" or \"node_id=1&port_id=3.")
...
class addReadingBulkTest(TestCase):
    ...
    def test_auth_token(self):
        response = self.client.get('/api/add_reading_bulk/', {'auth_token':"cherry",'json':'[[]]'})
        self.assertEqual(response.content, "Incorrect Authentication!")

    def test_json(self):
        response = self.client.get('/api/add_reading_bulk/', {'auth_token':"pear"})
    ...
    def test_single_insert(self):
        response = self.client.get('/api/add_reading_bulk/', {'auth_token':'pear','json':'[[1,1,333]]'})
        self.assertEqual(response.content,'\n\nTotal Insertion Attempts: 1\n\nSuccessful Insertions : 1\n\nAll records inserted!') 
    
    def test_multiple_insert(self):
        response = self.client.get('/api/add_reading_bulk/', {'auth_token':'pear','json':'[[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1,333],[1,1],[132,1,333],[1,333],[1,0,333]]'})
